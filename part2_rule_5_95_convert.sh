...
/bcftools-1.16/bcftools filter -i 'FORMAT/AF >= 0.05 ' ${tag}.pass.vcf.gz | /bcftools-1.16/bcftools filter -i 'FORMAT/AF <= 0.95 '      > ${tag}.pass.het.tmp.vcf
...
#3 select homo
/bcftools-1.16/bcftools filter -i 'FORMAT/AF > 0.95 ' ${tag}.pass.vcf.gz                                                  > ${tag}.pass.homo.tmp.vcf
